...
export default function AdminCard({ title, icon, children, className = '' }: AdminCardProps) {
    return (
        ...
        >
            ...
            <header className="relative z-10 flex items-center gap-2 border-b border-emerald-400/10 pb-2 mb-3">
                {icon}
                <h3 className="text-[16px] font-semibold text-emerald-100">{title}</h3>
            </header>
