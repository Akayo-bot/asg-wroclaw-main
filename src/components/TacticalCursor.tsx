...
const TacticalCursor = ({
    ...
    useEffect(() => {
        ...
        cornersRef.current = cursor.querySelectorAll('.tactical-cursor-corner');
        ...
        const mouseDownHandler = () => {
            if (!dotRef.current || !crosshairRef.current) return;
            gsap.to(dotRef.current, { scale: 0.5, duration: 0.2 });
            gsap.to(crosshairRef.current, { scale: 0.8, duration: 0.2 });
        ...
        const mouseUpHandler = () => {
            ...
            gsap.to(crosshairRef.current, { scale: 1, duration: 0.3 });
        ...
        const enterHandler = (e: MouseEvent) => {
            ...
            // Add glow effect when targeting
            gsap.to(cursorRef.current, {
    ...
    }, [targetSelector, spinDuration, moveCursor, constants, hideDefaultCursor, color]);
    ...
    return (
        ...
        >
            ...
            {/* Top-left corner */}
            <div
                className="tactical-cursor-corner absolute left-1/2 top-1/2 transform -translate-x-[150%] -translate-y-[150%] border-r-0 border-b-0"
                style={{
                    willChange: 'transform',
            ...
            {/* Top-right corner */}
            <div
                className="tactical-cursor-corner absolute left-1/2 top-1/2 transform translate-x-1/2 -translate-y-[150%] border-l-0 border-b-0"
                style={{
                    willChange: 'transform',
                    width: constants.cornerSize,
                    height: constants.cornerSize,
            ...
            {/* Bottom-right corner */}
            <div
                className="tactical-cursor-corner absolute left-1/2 top-1/2 transform translate-x-1/2 translate-y-1/2 border-l-0 border-t-0"
                style={{
                    willChange: 'transform',
                    width: constants.cornerSize,
                    height: constants.cornerSize,
            ...
            {/* Bottom-left corner */}
            <div
                className="tactical-cursor-corner absolute left-1/2 top-1/2 transform -translate-x-[150%] translate-y-1/2 border-r-0 border-t-0"
                style={{
                    willChange: 'transform',
                    width: constants.cornerSize,
                    height: constants.cornerSize,
