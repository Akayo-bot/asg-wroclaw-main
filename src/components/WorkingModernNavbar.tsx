...
const WorkingModernNavbar = () => {
    ...
    useEffect(() => {
        if (!activeElementRef.current || !navRef.current) return;
        ...
        if (items[activeIndex]) {
            ...
            const offset = itemRect.left - navRect.left + (itemRect.width - 100) / 2;
    ...
    return (
        ...
        .navigation-menu ul li:not(.active) a:hover {
          color: #4CAF50;
        }
...
export default WorkingModernNavbar;
